...
object Interaction2 {
  ...
  def availableLayers: Seq[Layer] = {
    Seq(
      Layer(LayerName.Temperatures, ReferenceColors.temperatureReferenceColors, 1975 to 1989),
      Layer(LayerName.Deviations, ReferenceColors.deviationReferenceColors, 1990 to 2015)
    )
  }
